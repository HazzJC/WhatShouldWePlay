...
const contentSecurityPolicy = process.env.NODE_ENV === "production"
  ? "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://images.igdb.com https://lh3.googleusercontent.com https://avatars.cloudflare.steamstatic.com https://avatars.akamai.steamstatic.com; connect-src 'self'; font-src 'self' data:; object-src 'none'; base-uri 'self'; frame-ancestors 'none'; form-action 'self'"
